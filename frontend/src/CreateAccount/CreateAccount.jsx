    ...
    <div>
      ...
      <form>
        <div className="inputs-ca">
          ...
          className={!isNameValid && name !== "" ? "name-input-ca-error" : "name-input-ca"}
          type="text"
          placeholder="Nome"
          />
          ...
          className={!isEmailValid && email !== "" ? "email-input-ca-error": "email-input-ca"}
          type="text"
          placeholder="Email"
          />
          ...
          <div
          className={!isPasswordValid && password !== "" ? "confirm-password-input-div-error" : "confirm-password-input-div"}
          >
            <input
        ...
        <div className={!isConfirmPasswordValid && confirmPassword !== "" ? "buttons-ca-password-error" : "buttons-ca"}>
          ...
          type="button"
          className={isButtonDisabled ? "access-btn-ca-disabled" : "access-btn-ca"}
